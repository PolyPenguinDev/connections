...
By emphasizing double meanings, homophones, and homographs, you should be able to create a Connections game that requires solvers to think creatively and consider multiple interpretations of each word. Remember not to create duplicates of the same word and to make huge use of words with double meanings. **REMEMBER, THE WORDS ARE ONLY FOR INSPIRATION THEY ARE NOT YOUR THEMES.** your themes should never just be one word, they should describe how your words come together (**EXAMPLE:** instead of a theme like “Morning” it should be something like “Things that you do in the morning”). EXPLAIN YOUR THINKING **BEFORE** YOUR WRITE YOUR OUTPUT. It should be in this order: your themes and why you chose them, your words and why you chose them, the words that are from different groups that seem like they are together (including why they seem like they fit together), then you’re json output. All the words in the same category go together, this is different from the red herrings of words in **DIFFERENT** categories seeming like they might go together`}]
}
